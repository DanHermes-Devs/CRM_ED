...
class VentasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($venta) {
            ...
            if ($venta->UGestion !== 'VENTA' && $venta->UGestion !== 'RENOVACION' && $venta->UGestion !== 'PROMESA DE PAGO') {
                ...
                if ($request->Codificacion === 'RENOVACION' || $request->Codificacion === 'VENTA') {
                    ...
                    if ($ventaRenovacion) {
                        ...
                        $venta->UGestion = $request->Codificacion;
                        $venta->Fpreventa = Carbon::now();
                        $venta->fill($request->all());
            ...
            if($request->Codificacion == 'VENTA'){
                ...
                if ($ventaExistente) {
                    ...
                    if ($ventaCoincidente) {
                        ...
                        // Si no hay una venta existente con el mismo RFC, TelCelular y NombreDeCliente se asigna tVenta 'VENTA'
                        $venta->tVenta = 'VENTA';
                    }
                }
            }
