                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control @error('hora_entrada') is-invalid @enderror" id="hora_entrada" name="hora_entrada">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control @error('hora_salida') is-invalid @enderror" id="hora_salida" name="hora_salida">
