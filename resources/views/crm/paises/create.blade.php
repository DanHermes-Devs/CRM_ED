        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">NUEVO PAÍS</h4>
                ...
                <div class="card crm-widget py-4 px-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <h4 class="text-left mb-3">AGREGAR NUEVO PAÍS</h4>
                        ...
                        <form action="{{ route('paises.store') }}" method="POST" novalidate>
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pais') is-invalid @enderror" id="pais" name="pais" placeholder="Nombre del país" value="{{ old('pais') }}">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light mb-3">Guardar país</button>
                        </form>
                    </div><!-- end card body -->
                </div><!-- end card -->
            </div><!-- end col -->
