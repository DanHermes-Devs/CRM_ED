                ...
                <div class="card crm-widget py-4 px-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column align-items-end justify-content-center">
                            @can('crear-pais')
                                <a href="{{ route('paises.create') }}" class="btn btn-primary waves-effect waves-light mb-3 d-flex align-items-center gap-1">
                                    <i class="ri-add-circle-line"></i>
                                    Agregar país
                                </a>
                            @endcan
                            <!-- Tables Without Borders -->
                            <table class="table table-middle table-nowrap mb-0" id="tabla_paises">
