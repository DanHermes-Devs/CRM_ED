                ...
                <div class="card-body">
                    <form action="{{ route('store-cronjob') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label for="idload_skilldata" class="form-label">ID Load Motor A</label>
                                    <input type="text" pattern="\d+" name="idload_skilldata" id="idload_skilldata" class="form-control @error ('idload_skilldata') is-invalid @enderror" placeholder="ID Load">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" pattern="\d+" name="idload_motor_b" id="idload_motor_b" class="form-control @error ('idload_motor_b') is-invalid @enderror" placeholder="ID Load">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" pattern="\d+" name="idload_motor_c" id="idload_motor_c" class="form-control @error ('idload_motor_c') is-invalid @enderror" placeholder="ID Load">
